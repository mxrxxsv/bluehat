  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-6 pt-14 px-4">
        ...
        <Link to="/bluehat/clientsignup" className="w-80 h-50 p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:border-[#89A8B2] hover:border-2">
        ...
        <Link to="/bluehat/workersignup" className="w-80 h-50 p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:border-[#89A8B2] hover:border-2">
