...
const AdsPage = () => {
    ...
    return (
        <>
            ...
            <div className='mt-25 ml-10 md:mt-40 md:ml-30 md:w-100 mb-8'>
                <h1 className='text-[24px] md:text-[32px] font-medium text-[#252525] opacity-80' >Free Government Training
                    and Certification</h1>
            </div>


                <a href="https://www.facebook.com/photo/?fbid=1040524924762206&set=a.447560497391988" class="flex flex-col mx-auto items-center bg-white rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 mt-4">
                ...
                <a href="https://www.facebook.com/photo/?fbid=1070893761724048&set=a.456274649852632" class="flex flex-col mx-auto items-center bg-white rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 mt-8 mb-10">
                    <img class="object-cover w-full rounded-t-lg h-full md:h-full md:w-48 md:rounded-none md:rounded-s-lg" src="https://scontent.fmnl3-1.fna.fbcdn.net/v/t39.30808-6/484951009_1070237201789704_2141881598104639452_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=127cfc&_nc_eui2=AeGLCcX8Jk9rTJfE4B9-EfZ0KBmZRmpDH9QoGZlGakMf1BsNT036zZs8ES7d9l667FUFnGkUD4cO72X5FAwvWMG8&_nc_ohc=oDlM7IzhshkQ7kNvwHGKqXs&_nc_oc=AdmwWXGoq3G3SB0SM1RzG0jWjoZBKCQjsBX8lmqtKsKl7Vsn2pxbJDWaqvmmW89GXCM&_nc_zt=23&_nc_ht=scontent.fmnl3-1.fna&_nc_gid=m7_kI_ReRcjFNxetuEywHg&oh=00_AfFG9dmhcR8KppuegkBqA5RsbJeFfpKW2OV_6JIBIpipvg&oe=6801A656" alt="" />
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        ...
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Dreaming of becoming a certified caregiver? Da Vinci is now accepting enrollees for a TESDA-Accredited Caregiving NCII Scholarship with FREE tuition! Gain the skills and knowledge you need to pass the NCII.</p>
                    </div>
                </a>
