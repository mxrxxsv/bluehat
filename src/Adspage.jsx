...
const AdsPage = () => {
    ...
    return (
        <>
            ...
            <div className='mt-25 ml-5 md:mt-40 md:ml-30 md:w-100 mb-8'>
                <h1 className='text-[24px] md:text-[32px] font-medium text-[#252525] opacity-80' >Free Government Training
                    and Certification</h1>
            </div>


                <a href="https://www.facebook.com/photo/?fbid=1040524924762206&set=a.447560497391988" class="flex flex-col mx-auto items-center bg-white rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 mt-4 ml-6 mr-6">
                ...
                <a href="https://www.facebook.com/photo/?fbid=1070893761724048&set=a.456274649852632" class="flex flex-col mx-auto items-center bg-white rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 mt-8 mb-10 ml-6 mr-6">
