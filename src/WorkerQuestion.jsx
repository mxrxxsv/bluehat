                    ...
                    <div className="w-full overflow-hidden">
                        <div className="flex transition-transform duration-300 ease-in-out"
                            ...
                            <div className="w-full flex-shrink-0">
                                ...
                                <button onClick={handlePrevStep} className="bg-neutral-700 hover:bg-gray-400 text-white px-6 py-2 rounded-md mr-2 cursor-pointer">Previous</button>
                                <Link to="/bluehat/workerpage" onClick={() => alert("Form Submitted!")} className="bg-sky-500 hover:bg-[#ADD8F5] text-white px-6 py-2 rounded-md cursor-pointer">Submit</Link>
                            </div>
                        </div>
                    </div>
                </div>
